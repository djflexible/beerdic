...
import kr.ac.kaist.swrc.jhannanum.plugin.SupplementPlugin.PosProcessor.NounExtractor.VerbExtractor;
 ...
 * There are several predefined work flows so users who don't want to set up the
 * work flow manually can use those general work flows: Morphological Analysis,
 * POS Tagging, and Noun Extraction.<br>
 * <br>
 * HanNanum work flow can be used through the following steps with the
 * WorkflowFactory:<br>
 * <br>
 ...
 * <br>
 * Take a look the demo program -
 * kr.ac.kaist.swrc.jhannanum.demo.PredefinedWorkflow for an example.<br>
 * <br>
 * 
...
public class WorkflowFactory {
	...
	public static final int WORKFLOW_VERB_EXTRACTOR = 0x06;

	/**
	 * Returns the predefined work flow according to the specified flag.
	 * 
	 * @param workflowFlag
	 *            - One of WORKFLOW_HMM_TAGGER, WORKFLOW_MORPH_ONLY,
	 *            WORKFLOW_NOUN_EXTRACT
	...
	public static Workflow getPredefinedWorkflow(int workflowFlag) {
		...
		case WORKFLOW_VERB_EXTRACTOR:
			...
			workflow.setPosTagger(new HMMTagger(), "conf/plugin/MajorPlugin/PosTagger/HmmPosTagger.json");
			workflow.appendPosProcessor(new VerbExtractor(), null);
			break;
